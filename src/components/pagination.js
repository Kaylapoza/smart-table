...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    ...
    let page = state.page;
        ...
        fromRow.textContent = total ? (page - 1) * limit + 1 : 0;                    // С какой строки выводим
        toRow.textContent = total ? Math.min((page * limit), total) : 0;    // До какой строки выводим, если это последняя страница, то отображаем оставшееся количество
